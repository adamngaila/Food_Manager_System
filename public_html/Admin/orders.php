  ...
  while ($row = $order_list->fetch_assoc()) {
     ?>
                  <tr>
                    ...
                    <td class="td-actions"><a href="<?php echo 'orders.php?id='.$row["Order_Id"] ?>" class="btn btn-small btn-success"><i class="btn-icon-only icon-ok"> </i></a><a href="<?php echo 'orders.php?Order_Id='.$row["Order_Id"] ?>" class="btn btn-danger btn-small"><i class="btn-icon-only icon-remove"> </i></a></td>
                  </tr>
                      <?php
    }
}
