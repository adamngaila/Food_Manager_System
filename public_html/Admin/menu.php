  ...
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        ...
        <li class="active"><a href="menu.php"><i class="icon-list-alt"></i><span>Food Menu</span> </a> </li>
								...
								<form method ="post" class="form-horizontal">
									<fieldset>
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="span6" id="food_details" name="food_details" value="" placeholder = "pilau kuku">
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="span6" id="bun" name="bun" value="" placeholder="Plate/bottle/pcs">
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="span4" id="price" name="price" value="" placeholder = "2500">
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
										...
										<div class="form-actions">
											<button type="submit" class="btn btn-primary" name="create_menu" value ="Submit">Save</button> 
  ...
  while ($row = $menu_list->fetch_assoc()) {
     ?>
                  <tr>
                    ...
                    <td class="td-actions"><a href="<?php echo 'menu.php?id='. $row["id"]?>" class="btn btn-danger btn-small"><i class="btn-icon-only icon-remove"> </i></a></td>
                  </tr>
                      <?php
    }
}
